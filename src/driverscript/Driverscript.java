	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 1; i <=excel.rowCount("MasterTestcases"); i++) {
			...
			if(excel.getData("MasterTestcases", i, 2).equalsIgnoreCase("Y")){
				...
				report=new ExtentReports("D:\\New folder (2)\\tanya\\StockAccounting_hybrid\\Reports\\"+TCModule+FunctionLibrary.generateDate()+".html");
				...
				for(int j=1;j<=excel.rowCount(TCModule);j++){
					...
					test.log(LogStatus.PASS, Description);
						...
						ModuleStatus="FAIL";
					String req_date=FunctionLibrary.generateDate();
						File srcFile=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
						FileUtils.copyFile(srcFile, new File("D:\\New folder(2)\\tanya\\StockAccounting_hybrid\\Scrnshort\\"+Description+req_date+".png"));
						test.log(LogStatus.FAIL, Description);
						test.log(LogStatus.INFO,test.addScreenCapture("D:\\New folder (2)\\tanya\\StockAccounting_hybrid\\Scrnshort"+Description+req_date+".png"));
						break;
					}  
